...
wspace = 0.200
hspace = 0.155
kws_points = dict(s=100, alpha=0.7, linewidth=0.7)
# ----------------------------------------------------------------------------------------------------------------------
f, (ax1, ax2) = plt.subplots(nrows=1, ncols=2, figsize=(15, 8.5))
axes = plt.gca()
...
ax1.axhline(2, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(3, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(4, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(5, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(6, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
...
ax1.set_title('')
ax1.set_xticks(ind)
ax1.set_yticklabels([0, 2, 4, 6, 8, 10], family='sans-serif', fontsize=12.5, color='black')
ax1.set_xticklabels(('Nile delta', 'Upper Egypt'), family='sans-serif', fontsize=14, color='black')
ax1.set_facecolor('whitesmoke')
# ----------------------------------------------------------------------------------------------------------------------
N = 2
ind = np.arange(N)  # the x locations for the groups
width = 0.75        # the width of the bars
Ya = list([100*6.8/9.0, 100*6.2/7.9])
Yw = list([100, 100])
...
ax1.axhline(10, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(20, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(30, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(40, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(50, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(60, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(70, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(80, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax1.axhline(90, color='gainsboro', linewidth=0.75, linestyle='-', zorder=0)
ax2.set_ylabel('Yield gap closure (% Yp)', family='sans-serif', fontsize=14, color='black', fontweight='bold')
ax2.set_ylim([0, 100])
ax2.set_title('')
ax2.set_xticks(ind)
ax2.set_yticklabels([0, 20, 40, 60, 80, 100], family='sans-serif', fontsize=12.5, color='black')
ax2.set_xticklabels(('Nile delta', 'Upper Egypt'), family='sans-serif', fontsize=14, color='black')
ax2.set_facecolor('whitesmoke')
# ----------------------------------------------------------------------------------------------------------------------
plt.savefig(os.path.join(output_dir, r"./yield gap closure.jpeg"), bbox_inches='tight')
...
for year, site in product(years, sites):
    ...
    # ----------------------------------------------------------------------------------------------------------
    # Load input data
    daily = pd.read_csv(os.path.join(input_dir, r'./daily_wheat_{site}_{year}_updated.csv'.format(site=site, year=year)))
...
for site in sites:
    ...
    # ------------------------------------------------------------------------------------------------------------------
    plt.savefig(os.path.join(output_dir, r"./daily_wheat_{site}_improved_TSUM_AMAX2_updated.pdf".format(site=site)), bbox_inches='tight')

# ----------------------------------------------------------------------------------------------------------------------
# PLOT SUMMARY
# ----------------------------------------------------------------------------------------------------------------------

summary = pd.read_csv(os.path.join(input_dir, r'./summary_wheat_egypt_updated.csv'))
...
for site in sites:
    ...
    # ------------------------------------------------------------------------------------------------------------------
    plt.savefig(os.path.join(output_dir, r"./summary_wheat_{site}_improved_TSUM_AMAX2_updated.pdf".format(site=site)), bbox_inches='tight')
