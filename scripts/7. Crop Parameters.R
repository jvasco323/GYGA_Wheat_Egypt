...
l_int_D2 <- list(nile_delta = c(52, 54), upper_egpyt = c(140-80, 131-69))
...
weather_files <- c("weather_actual_UpperEgypt_unformatted.xlsx", "weather_actual_NileDelta_unformatted.xlsx")
...
round(mean(TSUM$TSUM1[TSUM$station_name=='nile_delta']), 0)
round(mean(TSUM$TSUM2[TSUM$station_name=='nile_delta']), 0)
round(mean(TSUM$TSUM1[TSUM$station_name=='upper_egpyt']), 0)
round(mean(TSUM$TSUM2[TSUM$station_name=='upper_egpyt']), 0)
